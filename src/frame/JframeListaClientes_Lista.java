 ...
 * @author Jefson
 */
public class JframeListaClientes_Lista extends javax.swing.JFrame {
     ...
     */
    public JframeListaClientes_Lista() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnNovo, jButton1, jButton2});
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtCodigo, txtRazao});
    ...
    private void tblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientesMouseClicked
        ...
        for (Cliente cliente : clientes) {
            c.txtNome.setText(cliente.getClinome());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JframeListaClientes_Lista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JframeListaClientes_Lista().setVisible(true);
            }
        });
    }
