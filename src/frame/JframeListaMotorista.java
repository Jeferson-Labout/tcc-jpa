 ...
 * @author Jefson
 */
public class JframeListaMotorista extends javax.swing.JFrame {
 ...
 public void atualizatabela() {
    ...
    private void tblUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblUsuarioMouseClicked
        ...
        for (Cliente cliente : clientes) {
            ...
            c.txtCodMotorista.setText(cliente.getCliid().toString());
            c.txtMotorista.setText(cliente.getClinome());
            c.txtCodMotorista.setEditable(false);
            c.txtMotorista.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JframeListaMotorista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JframeListaMotorista().setVisible(true);
            }
        });
    }
